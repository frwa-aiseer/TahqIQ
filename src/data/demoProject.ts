...
export function createEmptyProject(overrides?: Partial<ProjectState>): ProjectState {
  ...
  return {
    ...
    discipline: overrides?.discipline || "Researcher input required",
    subdiscipline: overrides?.subdiscipline || "",
    projectType: overrides?.projectType || "Custom scholarly project",
    createdAt: now,
    updatedAt: now,
    ...
    reportingGuideline: {
      ...
      applicableStudyType: "Researcher input required",
      checklistItems: [],
    },
    ethicsInfo: {
